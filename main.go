...
func main() {
	...
	go CountingPunctuation(fileData[:10688529], ch1)
	go CountingPunctuation(fileData[10688529:21377058], ch1)
	go CountingPunctuation(fileData[21377058:32065587], ch1)
	go CountingPunctuation(fileData[32065587:42754116], ch1)
	go CountingPunctuation(fileData[42754116:], ch1)
	...
	fmt.Println("\ntotal lines ", res1.totalLines+res2.totalLines+res3.totalLines+res4.totalLines+res5.totalLines+1)
